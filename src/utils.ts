...
export
    var xmlencode = function(str: string): string {
...
export
    var ansispan = function(str: string): string {
...
export
    var fixConsole = function(txt: string): string {
        txt = xmlencode(txt);
...
export
    var fixCarriageReturn = function(txt: string) {
        var tmp = txt;
        do {
            txt = tmp;
            tmp = txt.replace(/\r+\n/gm, '\n'); // \r followed by \n --> newline
...
export
    var autoLinkUrls = function(txt: string): string {
